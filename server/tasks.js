...
const DAYS = [
  {
    ...
    blocks: [
      ...
      { type: 'p', text: '儲值：私訊婕樂纖加盟商官方客服，提供直屬皇家姓名、直屬上家姓名、加盟商姓名、加盟商電話、級別、欲儲值的 SP 點數（最少200元）、匯款帳號後五碼＋匯款截圖。' },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'subhead', text: '範例參考（請照原文使用，不隨意更改）' },
      { type: 'quote', text: 'Alice 白百伊 雙子座｜女性成長\n不節食小基數瘦6公斤\n提供免費諮詢養好體態 +LINE@543sttfl' },
    ],
    submitHint: '簡述你完成的頭貼／簡介／名字設定，並確認帳號已改為公開',
  },
  {
    day: 3,
    minutes: 10,
    ...
    pin: '305',
    blocks: [
      { type: 'p', lead: true, text: '限時動態要讓大家看得懂，不是自己看懂就好。' },
      { type: 'p', text: '字體APP推薦：下筆、Vivisticker' },
      { type: 'list', items: [
        '字體不要超過三個',
        '注意字間距、行距',
        '內容記得分段',
      ...
      { type: 'list', items: [
        'BA背景：錯誤示範是雜亂背景配螢光／高彩度字體；正確示範是乾淨深色背景配白色文字，重點一眼就能看到。',
        '詢問截圖：避免LINE對話截圖背景太過花俏，導致重點錯誤、看不清重點內容，建議使用乾淨顏色背景。',
      ]},
      { type: 'p', text: '限動比例：9:16　背景：不要用漸層　其他：LINE主題／IG主題背景可自行搭配。' },
    ],
